...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Camarón</h5>
...
<div class="card-deck">
 ...
 <p class="card-text"><small class="text-muted">Torta $ 39.00, ORD 3 $ 39.00</small></p>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Camarón y carnitas</h5>
...
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Camarón y pulpo</h5>
...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Garibaldi (camarón & sazonador)</h5>
...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Camarón, calamar y pulpo</h5>
      <p class="card-text"><small class="text-muted">Chico $ 69.00, Mediano $ 89.00 y Grande $ 119.00</small></p>
    </div>
  </div>
  <div class="card">
...
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Café c/galletas (3pzs.)</h5>
      <p class="card-text"><small class="text-muted">$ 25.00</small></p>
    </div>
  </div>
  <div class="card">
