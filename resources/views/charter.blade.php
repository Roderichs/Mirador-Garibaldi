    ...
    *, *:after, *:before {
    ...
    <div class="wrapper fixed-left">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-light" style="justify-content: center; align-items: center; ">
              
              <form class="form-inline col-sm-3">
              <div class="card">
                <img class="card-img-top img-thumbnail img-fluid" src="{{ asset('img/12.jpg') }}" alt="Card image cap">
                <button class="btn btn-dark font-italic" type="button">
                  <a href="{{ asset('/drink') }}" style="color: #fff;">
                    <bold> "Drinks" </bold>
                  </a>
                </button>
              </div>
              ...
              <form class="form-inline col-sm-3">
              <div class="card">
                <img class="card-img-top img-thumbnail img-fluid" src="{{ asset('img/13.jpg') }}" alt="Card image cap">
                <button class="btn btn-dark font-italic" type="button">
                  <a href="{{ asset('/saucer') }}" style="color: #fff;">
                    <bold> "Saucers" </bold>
                  </a>
                </button>
              </div>
