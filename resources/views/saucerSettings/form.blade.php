...
<div class="form-group">
	...
	<input type="text" class="form-control {{ $errors->has('nombre')?'is-invalid':'' }} is-invalid" name="nombre" id="nombre"
		value="{{ isset($saucersettings->nombre)?$saucersettings->nombre:old('nombre') }}"
	>
...
<div class="form-group">
	...
	<input type="text" class="form-control {{ $errors->has('descripcion')?'is-invalid':'' }}" name="descripcion" id="descripcion"
		value="{{ isset($saucersettings->descripcion)?$saucersettings->descripcion:old('descripcion') }}"
	>
...
<div class="form-group">
	...
	<input type="text" class="form-control {{ $errors->has('precio')?'is-invalid':'' }}" name="precio" id="precio"
		value="{{ isset($saucersettings->precio)?$saucersettings->precio:old('precio') }}"
	>
...
<div class="form-group">
	...
	@if(isset($saucersettings->foto))
		<br/>
		<img class="img-thumbnail img-fluid" src="{{ asset('storage').'/'.$saucersettings->foto }}" alt="" width="200">
		<br/>
	@endif
